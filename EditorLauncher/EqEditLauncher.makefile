...
Release_Preprocessor_Definitions=-D GCC_BUILD -D NDEBUG -D _WINDOWS -D _CRT_SECURE_NO_DEPRECATE -D _DKLAUNCHER_ -D _CRT_SECURE_NO_WARNINGS 
...
.PHONY: Debug
Debug: create_folders gccDebug/../public/Platform/Platform.o gccDebug/editorlauncher_win.o 
	g++ gccDebug/../public/Platform/Platform.o gccDebug/editorlauncher_win.o  $(Debug_Library_Path) $(Debug_Libraries) -Wl,-rpath,./ -o gccDebug/EqEditLauncher.exe
...
# Compiles file editorlauncher_win.cpp for the Debug configuration...
-include gccDebug/editorlauncher_win.d
gccDebug/editorlauncher_win.o: editorlauncher_win.cpp
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -c editorlauncher_win.cpp $(Debug_Include_Path) -o gccDebug/editorlauncher_win.o
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -MM editorlauncher_win.cpp $(Debug_Include_Path) > gccDebug/editorlauncher_win.d

# Builds the Long configuration...
.PHONY: Long
Long: create_folders gccLong/../public/Platform/Platform.o gccLong/editorlauncher_win.o 
	g++ gccLong/../public/Platform/Platform.o gccLong/editorlauncher_win.o  $(Long_Library_Path) $(Long_Libraries) -Wl,-rpath,./ -o gccLong/EqEditLauncher.exe
...
# Compiles file editorlauncher_win.cpp for the Long configuration...
-include gccLong/editorlauncher_win.d
gccLong/editorlauncher_win.o: editorlauncher_win.cpp
	$(CPP_COMPILER) $(Long_Preprocessor_Definitions) $(Long_Compiler_Flags) -c editorlauncher_win.cpp $(Long_Include_Path) -o gccLong/editorlauncher_win.o
	$(CPP_COMPILER) $(Long_Preprocessor_Definitions) $(Long_Compiler_Flags) -MM editorlauncher_win.cpp $(Long_Include_Path) > gccLong/editorlauncher_win.d

# Builds the PigeonGameRelease configuration...
.PHONY: PigeonGameRelease
PigeonGameRelease: create_folders ./Compile/Launcher/gccRelease/../public/Platform/Platform.o ./Compile/Launcher/gccRelease/editorlauncher_win.o 
	g++ ./Compile/Launcher/gccRelease/../public/Platform/Platform.o ./Compile/Launcher/gccRelease/editorlauncher_win.o  $(PigeonGameRelease_Library_Path) $(PigeonGameRelease_Libraries) -Wl,-rpath,./ -o ./Compile/Launcher/gccRelease/EqEditLauncher.exe
...
# Compiles file editorlauncher_win.cpp for the PigeonGameRelease configuration...
-include ./Compile/Launcher/gccRelease/editorlauncher_win.d
./Compile/Launcher/gccRelease/editorlauncher_win.o: editorlauncher_win.cpp
	$(CPP_COMPILER) $(PigeonGameRelease_Preprocessor_Definitions) $(PigeonGameRelease_Compiler_Flags) -c editorlauncher_win.cpp $(PigeonGameRelease_Include_Path) -o ./Compile/Launcher/gccRelease/editorlauncher_win.o
	$(CPP_COMPILER) $(PigeonGameRelease_Preprocessor_Definitions) $(PigeonGameRelease_Compiler_Flags) -MM editorlauncher_win.cpp $(PigeonGameRelease_Include_Path) > ./Compile/Launcher/gccRelease/editorlauncher_win.d

# Builds the Release configuration...
.PHONY: Release
Release: create_folders gccRelease/../public/Platform/Platform.o gccRelease/editorlauncher_win.o 
	g++ gccRelease/../public/Platform/Platform.o gccRelease/editorlauncher_win.o  $(Release_Library_Path) $(Release_Libraries) -Wl,-rpath,./ -o gccRelease/EqEditLauncher.exe
...
# Compiles file editorlauncher_win.cpp for the Release configuration...
-include gccRelease/editorlauncher_win.d
gccRelease/editorlauncher_win.o: editorlauncher_win.cpp
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -c editorlauncher_win.cpp $(Release_Include_Path) -o gccRelease/editorlauncher_win.o
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -MM editorlauncher_win.cpp $(Release_Include_Path) > gccRelease/editorlauncher_win.d
