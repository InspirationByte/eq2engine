...
void CGLRenderLib_EGL::BeginFrame(ISwapChain* swapChain)
{
...
// creates swap chain
ISwapChain* CGLRenderLib_EGL::CreateSwapChain(const RenderWindowInfo& windowInfo)
{
...
void  CGLRenderLib_EGL::DestroySwapChain(ISwapChain* swapChain)
{
