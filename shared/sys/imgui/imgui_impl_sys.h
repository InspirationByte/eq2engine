...
IMGUI_IMPL_API void ImGui_ImplEq_NewFrame();

IMGUI_IMPL_API void ImGui_ImplEq_UpdateMousePosAndButtons();
IMGUI_IMPL_API void ImGui_ImplEq_UpdateGamepads();

IMGUI_IMPL_API bool ImGui_ImplEq_AnyItemShown();
