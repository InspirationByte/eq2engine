...
public:
	...
	bool						Rename(const char* oldNameOrPath, const char* newNameOrPath, ESearchPath search) const;
	
	//Directory operations
	bool						DirExist(const char* dirname, ESearchPath search) const;
	bool						MakeDir(const char* dirname, ESearchPath search ) const;
	bool						RemoveDir(const char* dirname, ESearchPath search ) const;
	...
	bool						FileRemove(const char* filename, ESearchPath search ) const;
