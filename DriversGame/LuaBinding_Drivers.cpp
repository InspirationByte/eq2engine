...
bool LuaBinding_InitDriverSyndicateBindings(lua_State* state)
{
	...
	// HUD
	LUA_SET_GLOBAL_ENUMCONST(state, HUDTARGET_FLAG_SHOWONMAP);
	LUA_SET_GLOBAL_ENUMCONST(state, HUDTARGET_FLAG_COP);
	LUA_SET_GLOBAL_ENUMCONST(state, HUDTARGET_FLAG_CAR_DAMAGE);
	LUA_SET_GLOBAL_ENUMCONST(state, HUDTARGET_FLAG_PLAYER);
