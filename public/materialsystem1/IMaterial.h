...
enum EMaterialFlags : int
{
	...
	MATERIAL_FLAG_REVERSE_CULL		= (1 << 1),		// reverse culling (draw back faces instead of front faces)
	...
	MATERIAL_FLAG_WIREFRAME			= (1 << 9),

	MATERIAL_FLAG_SKINNED			= (1 << 10),	// this material can be applied on skinned mesh, using vertex shaders
	MATERIAL_FLAG_VERTEX_BLEND		= (1 << 11),	// this material is uses vertex blending
	MATERIAL_FLAG_VERTEX_TRANSITION = (1 << 12),	// transits textures to create painting effect (vertex transition)

	MATERIAL_FLAG_ALPHATESTED		= (1 << 13),	// has alphatesting
	MATERIAL_FLAG_TRANSPARENT		= (1 << 14),	// has transparency

	MATERIAL_FLAG_SKY				= (1 << 15),	// used for skybox
	MATERIAL_FLAG_WATER				= (1 << 16),	// this is water material
};
