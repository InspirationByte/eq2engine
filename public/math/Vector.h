...
// quadratic bezier interpolation
Vector3D	bezierQuadratic(const Vector3D& p1, const Vector3D& p2, const Vector3D& p3, float t);
...
static const MColor color_purple	= MColor(0xFFFA00FA, true);
static const MColor color_blue		= MColor(0xFF0000FF, true);
static const MColor color_green		= MColor(0xFF00F900, true);
