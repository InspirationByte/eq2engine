...
bool LuaBinding_InitEngineBindings(lua_State* state)
{
	...
	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_STYLE_SHADOW);
	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_STYLE_WIDTHRATIO);

	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_STYLE_CENTER);
	...
	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_ALIGN_CENTER);

	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_ORIENT_RIGHT);
	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_ORIENT_UP);
	LUA_SET_GLOBAL_ENUMCONST(state, TEXT_ORIENT_DOWN);
