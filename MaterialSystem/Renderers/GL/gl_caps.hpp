...
namespace gl
{
	namespace exts
	{
		...
		extern LoadTest var_EXT_draw_buffers2;
		extern LoadTest var_ARB_half_float_pixel;
	...
	namespace _detail
	{
		...
		extern void (CODEGEN_FUNCPTR *CompileShaderARB)(GLhandleARB shaderObj);
		extern GLhandleARB (CODEGEN_FUNCPTR *CreateProgramObjectARB)(void);
		extern GLhandleARB (CODEGEN_FUNCPTR *CreateShaderObjectARB)(GLenum shaderType);
		extern void (CODEGEN_FUNCPTR *DeleteObjectARB)(GLhandleARB obj);
		extern void (CODEGEN_FUNCPTR *DetachObjectARB)(GLhandleARB containerObj, GLhandleARB attachedObj);
		extern void (CODEGEN_FUNCPTR *GetActiveUniformARB)(GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei * length, GLint * size, GLenum * type, GLcharARB * name);
		extern void (CODEGEN_FUNCPTR *GetAttachedObjectsARB)(GLhandleARB containerObj, GLsizei maxCount, GLsizei * count, GLhandleARB * obj);
		extern GLhandleARB (CODEGEN_FUNCPTR *GetHandleARB)(GLenum pname);
		extern void (CODEGEN_FUNCPTR *GetInfoLogARB)(GLhandleARB obj, GLsizei maxLength, GLsizei * length, GLcharARB * infoLog);
		extern void (CODEGEN_FUNCPTR *GetObjectParameterfvARB)(GLhandleARB obj, GLenum pname, GLfloat * params);
		extern void (CODEGEN_FUNCPTR *GetObjectParameterivARB)(GLhandleARB obj, GLenum pname, GLint * params);
		extern void (CODEGEN_FUNCPTR *GetShaderSourceARB)(GLhandleARB obj, GLsizei maxLength, GLsizei * length, GLcharARB * source);
		extern GLint (CODEGEN_FUNCPTR *GetUniformLocationARB)(GLhandleARB programObj, const GLcharARB * name);
		extern void (CODEGEN_FUNCPTR *GetUniformfvARB)(GLhandleARB programObj, GLint location, GLfloat * params);
		extern void (CODEGEN_FUNCPTR *GetUniformivARB)(GLhandleARB programObj, GLint location, GLint * params);
		extern void (CODEGEN_FUNCPTR *LinkProgramARB)(GLhandleARB programObj);
		extern void (CODEGEN_FUNCPTR *ShaderSourceARB)(GLhandleARB shaderObj, GLsizei count, const GLcharARB ** string, const GLint * length);
		extern void (CODEGEN_FUNCPTR *Uniform1fARB)(GLint location, GLfloat v0);
		extern void (CODEGEN_FUNCPTR *Uniform1fvARB)(GLint location, GLsizei count, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *Uniform1iARB)(GLint location, GLint v0);
		extern void (CODEGEN_FUNCPTR *Uniform1ivARB)(GLint location, GLsizei count, const GLint * value);
		extern void (CODEGEN_FUNCPTR *Uniform2fARB)(GLint location, GLfloat v0, GLfloat v1);
		extern void (CODEGEN_FUNCPTR *Uniform2fvARB)(GLint location, GLsizei count, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *Uniform2iARB)(GLint location, GLint v0, GLint v1);
		extern void (CODEGEN_FUNCPTR *Uniform2ivARB)(GLint location, GLsizei count, const GLint * value);
		extern void (CODEGEN_FUNCPTR *Uniform3fARB)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
		extern void (CODEGEN_FUNCPTR *Uniform3fvARB)(GLint location, GLsizei count, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *Uniform3iARB)(GLint location, GLint v0, GLint v1, GLint v2);
		extern void (CODEGEN_FUNCPTR *Uniform3ivARB)(GLint location, GLsizei count, const GLint * value);
		extern void (CODEGEN_FUNCPTR *Uniform4fARB)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
		extern void (CODEGEN_FUNCPTR *Uniform4fvARB)(GLint location, GLsizei count, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *Uniform4iARB)(GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
		extern void (CODEGEN_FUNCPTR *Uniform4ivARB)(GLint location, GLsizei count, const GLint * value);
		extern void (CODEGEN_FUNCPTR *UniformMatrix2fvARB)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *UniformMatrix3fvARB)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
		extern void (CODEGEN_FUNCPTR *UniformMatrix4fvARB)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
		...
		extern void (CODEGEN_FUNCPTR *DrawBuffersARB)(GLsizei n, const GLenum * bufs);
		
		extern void (CODEGEN_FUNCPTR *ColorMaskIndexedEXT)(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
	...
	inline void DrawElementsInstancedARB(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei primcount){_detail::DrawElementsInstancedARB(mode, count, type, indices, primcount);}
	...
	inline void CompileShaderARB(GLhandleARB shaderObj){_detail::CompileShaderARB(shaderObj);}
	inline GLhandleARB CreateProgramObjectARB(void){return _detail::CreateProgramObjectARB();}
	inline GLhandleARB CreateShaderObjectARB(GLenum shaderType){return _detail::CreateShaderObjectARB(shaderType);}
	inline void DeleteObjectARB(GLhandleARB obj){_detail::DeleteObjectARB(obj);}
	inline void DetachObjectARB(GLhandleARB containerObj, GLhandleARB attachedObj){_detail::DetachObjectARB(containerObj, attachedObj);}
	inline void GetActiveUniformARB(GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei * length, GLint * size, GLenum * type, GLcharARB * name){_detail::GetActiveUniformARB(programObj, index, maxLength, length, size, type, name);}
	inline void GetAttachedObjectsARB(GLhandleARB containerObj, GLsizei maxCount, GLsizei * count, GLhandleARB * obj){_detail::GetAttachedObjectsARB(containerObj, maxCount, count, obj);}
	inline GLhandleARB GetHandleARB(GLenum pname){return _detail::GetHandleARB(pname);}
	inline void GetInfoLogARB(GLhandleARB obj, GLsizei maxLength, GLsizei * length, GLcharARB * infoLog){_detail::GetInfoLogARB(obj, maxLength, length, infoLog);}
	inline void GetObjectParameterfvARB(GLhandleARB obj, GLenum pname, GLfloat * params){_detail::GetObjectParameterfvARB(obj, pname, params);}
	inline void GetObjectParameterivARB(GLhandleARB obj, GLenum pname, GLint * params){_detail::GetObjectParameterivARB(obj, pname, params);}
	inline void GetShaderSourceARB(GLhandleARB obj, GLsizei maxLength, GLsizei * length, GLcharARB * source){_detail::GetShaderSourceARB(obj, maxLength, length, source);}
	inline GLint GetUniformLocationARB(GLhandleARB programObj, const GLcharARB * name){return _detail::GetUniformLocationARB(programObj, name);}
	inline void GetUniformfvARB(GLhandleARB programObj, GLint location, GLfloat * params){_detail::GetUniformfvARB(programObj, location, params);}
	inline void GetUniformivARB(GLhandleARB programObj, GLint location, GLint * params){_detail::GetUniformivARB(programObj, location, params);}
	inline void LinkProgramARB(GLhandleARB programObj){_detail::LinkProgramARB(programObj);}
	inline void ShaderSourceARB(GLhandleARB shaderObj, GLsizei count, const GLcharARB ** string, const GLint * length){_detail::ShaderSourceARB(shaderObj, count, string, length);}
	inline void Uniform1fARB(GLint location, GLfloat v0){_detail::Uniform1fARB(location, v0);}
	inline void Uniform1fvARB(GLint location, GLsizei count, const GLfloat * value){_detail::Uniform1fvARB(location, count, value);}
	inline void Uniform1iARB(GLint location, GLint v0){_detail::Uniform1iARB(location, v0);}
	inline void Uniform1ivARB(GLint location, GLsizei count, const GLint * value){_detail::Uniform1ivARB(location, count, value);}
	inline void Uniform2fARB(GLint location, GLfloat v0, GLfloat v1){_detail::Uniform2fARB(location, v0, v1);}
	inline void Uniform2fvARB(GLint location, GLsizei count, const GLfloat * value){_detail::Uniform2fvARB(location, count, value);}
	inline void Uniform2iARB(GLint location, GLint v0, GLint v1){_detail::Uniform2iARB(location, v0, v1);}
	inline void Uniform2ivARB(GLint location, GLsizei count, const GLint * value){_detail::Uniform2ivARB(location, count, value);}
	inline void Uniform3fARB(GLint location, GLfloat v0, GLfloat v1, GLfloat v2){_detail::Uniform3fARB(location, v0, v1, v2);}
	inline void Uniform3fvARB(GLint location, GLsizei count, const GLfloat * value){_detail::Uniform3fvARB(location, count, value);}
	inline void Uniform3iARB(GLint location, GLint v0, GLint v1, GLint v2){_detail::Uniform3iARB(location, v0, v1, v2);}
	inline void Uniform3ivARB(GLint location, GLsizei count, const GLint * value){_detail::Uniform3ivARB(location, count, value);}
	inline void Uniform4fARB(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3){_detail::Uniform4fARB(location, v0, v1, v2, v3);}
	inline void Uniform4fvARB(GLint location, GLsizei count, const GLfloat * value){_detail::Uniform4fvARB(location, count, value);}
	inline void Uniform4iARB(GLint location, GLint v0, GLint v1, GLint v2, GLint v3){_detail::Uniform4iARB(location, v0, v1, v2, v3);}
	inline void Uniform4ivARB(GLint location, GLsizei count, const GLint * value){_detail::Uniform4ivARB(location, count, value);}
	inline void UniformMatrix2fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value){_detail::UniformMatrix2fvARB(location, count, transpose, value);}
	inline void UniformMatrix3fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value){_detail::UniformMatrix3fvARB(location, count, transpose, value);}
	inline void UniformMatrix4fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value){_detail::UniformMatrix4fvARB(location, count, transpose, value);}
	...
	inline void DrawBuffersARB(GLsizei n, const GLenum * bufs){_detail::DrawBuffersARB(n, bufs);}
	
	inline void ColorMaskIndexedEXT(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a){_detail::ColorMaskIndexedEXT(index, r, g, b, a);}
	inline void DisableIndexedEXT(GLenum target, GLuint index){_detail::DisableIndexedEXT(target, index);}
	inline void EnableIndexedEXT(GLenum target, GLuint index){_detail::EnableIndexedEXT(target, index);}
	inline void GetBooleanIndexedvEXT(GLenum target, GLuint index, GLboolean * data){_detail::GetBooleanIndexedvEXT(target, index, data);}
	inline void GetIntegerIndexedvEXT(GLenum target, GLuint index, GLint * data){_detail::GetIntegerIndexedvEXT(target, index, data);}
	inline GLboolean IsEnabledIndexedEXT(GLenum target, GLuint index){return _detail::IsEnabledIndexedEXT(target, index);}
