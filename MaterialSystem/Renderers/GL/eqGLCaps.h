...
typedef GLvoid	  (APIENTRY * PGLFNGLBLITFRAMEBUFFEREXTPROC)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
extern PGLFNGLBLITFRAMEBUFFEREXTPROC		  glBlitFramebufferEXT;
...
#define GL_VERSION_3_1_PROTOTYPES
...
#if defined(_WIN32)
void InitializeGLExtCaps(HDC hdc);
#elif defined(LINUX)
void InitializeGLExtCaps(Display *display);
#elif defined(__APPLE__)
void InitializeGLExtCaps();
#endif
