...
PGLFNGLBLITFRAMEBUFFEREXTPROC		   glBlitFramebufferEXT = NULL;
...
void InitializeGLExtCaps(HDC hdc)
{
		...
		((wglGetExtensionsStringARB = (PFNWGLGETEXTENSIONSSTRINGARBPROC) wglxGetProcAddress("wglGetExtensionsStringEXT")) != NULL))
	{
		...
		wglCreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC) wglxGetProcAddress("wglCreateContextAttribsARB");
	}

	glGetStringi = (PFNGLGETSTRINGIPROC) wglxGetProcAddress("glGetStringi");
...
void InitializeGLExtCaps()
{
	...
	if (GL_EXT_framebuffer_object_supported = isExtensionSupported("GL_EXT_framebuffer_object"))
	{
		...
		glBlitFramebufferEXT	 = (PGLFNGLBLITFRAMEBUFFEREXTPROC) wglxGetProcAddress("glBlitFramebufferEXT");
