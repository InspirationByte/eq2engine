...
public:
	...
	void	Lock(texlockdata_t* pLockData, Rectangle_t* pRect = NULL, bool bDiscard = false, bool bReadOnly = false, int nLevel = 0, int nCubeFaceId = 0) {m_lockData = malloc(1024*1024);pLockData->pData = (ubyte*)m_lockData;}
