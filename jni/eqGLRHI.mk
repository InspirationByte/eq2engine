...
LOCAL_CPPFLAGS    		:= -DANDROID -DUSE_GLES2 -DCORE_EXPORT -DDLL_EXPORT -DRENDER_EXPORT -DIS_OPENGL -std=c++11 -pthread -fexceptions
LOCAL_CFLAGS    		:= -DANDROID -DUSE_GLES2 -DCORE_EXPORT -DDLL_EXPORT -DRENDER_EXPORT -DIS_OPENGL -pthread -fexceptions
