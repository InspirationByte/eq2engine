...
LOCAL_CPPFLAGS    		:= -DUSE_GLES2 -DCORE_EXPORT -DDLL_EXPORT -DRENDER_EXPORT -DIS_OPENGL
LOCAL_CFLAGS    		:= -DUSE_GLES2 -DCORE_EXPORT -DDLL_EXPORT -DRENDER_EXPORT -DIS_OPENGL
