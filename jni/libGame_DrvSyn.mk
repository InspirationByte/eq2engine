...
LOCAL_CPPFLAGS    		:= -g -DNO_ENGINE -DBIG_REPLAYS -DNOENGINE -DGAME_DRIVERS -DEQ_USE_SDL -DSHINY_STATIC_LINK=TRUE -DSHINY_IS_COMPILED=TRUE -Wno-invalid-offsetof
LOCAL_CFLAGS    		:= -g -DNO_ENGINE -DBIG_REPLAYS -DNOENGINE -DGAME_DRIVERS -DEQ_USE_SDL -DSHINY_STATIC_LINK=TRUE -DSHINY_IS_COMPILED=TRUE -Wno-invalid-offsetof
