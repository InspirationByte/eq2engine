...
LOCAL_CPPFLAGS    		:= -g -DANDROID -DNO_ENGINE -DBIG_REPLAYS -DNOENGINE -DGAME_DRIVERS -DEQ_USE_SDL -DSHINY_STATIC_LINK=TRUE -std=c++11 -pthread -fexceptions -Wno-invalid-offsetof
LOCAL_CFLAGS    		:= -g -DANDROID -DNO_ENGINE -DBIG_REPLAYS -DNOENGINE -DGAME_DRIVERS -DEQ_USE_SDL -DSHINY_STATIC_LINK=TRUE -pthread -fexceptions -Wno-invalid-offsetof
